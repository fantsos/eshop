...
const faqs = {
  en: [
    ...
    { q: "How can I contact customer support?", a: "You can reach us via email at info@eshop.fantsos.gr or through our contact form." },
  ],
  el: [
    ...
    { q: "Πώς μπορώ να επικοινωνήσω;", a: "Μπορείτε να μας βρείτε στο info@eshop.fantsos.gr ή μέσω της φόρμας επικοινωνίας." },
  ],
};
